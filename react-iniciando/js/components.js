  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("input", { type: "text", className: "form-control", id: "name", placeholder: "Name", style: InputStyle, onChange: this.handleNameChange })
      ),
      React.createElement(
        "div",
        { className: "form-group" },
        ...
        React.createElement("input", { type: "email", className: "form-control", id: "email", placeholder: "E-mail", style: InputStyle, onChange: this.handleEmailChange })
      ),
      React.createElement(
        "div",
        { className: "form-group" },
      ...
      React.createElement(
        "div",
        { className: "form-group" },
        React.createElement("label", { htmlFor: "messenger" }),
        React.createElement("textarea", { className: "form-control", id: "messenger", rows: "3", style: InputStyle, onChange: this.handleMessengerChange })
      ),
